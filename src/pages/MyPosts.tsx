...
import { useUserPosts, useDeleteUserPost, useUpdateUserPostStatus } from "@/hooks/usePosts";
...
export default function MyPosts() {
  ...
  const updatePostStatus = useUpdateUserPostStatus();
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <h1 className="text-2xl font-bold text-foreground">我的文章</h1>
                      ...
                      <div className="flex items-center justify-end gap-1">
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button variant="ghost" size="icon" onClick={() => navigate(`/post/slug/${post.slug}`)}>
                        ...
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <Button variant="ghost" size="icon" onClick={() => navigate(`/write/${post.id}`)}>
